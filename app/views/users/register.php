     ...
     <div>
          <div class="col-md-6 mx-auto">
               <div class="card card-body bg-light mt-5">
                    <h2>Ustvari Račun</h2>
                    <p>Prosim izpolnite, da se lahko registrirate kot nov uporabnik</p>
                    ...
                    <div class="row">
                         <div class="col">
                              <input type="submit" value="Registriraj se" class="btn btn-success btn-block">
                         </div>
                         <div class="col">
                              <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-light btn-block">Že imate račun? Vpis</a>
                         </div>
                    </div>
               </form>
               </div>
